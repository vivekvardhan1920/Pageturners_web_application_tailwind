...
import { GoogleAuthProvider, createUserWithEmailAndPassword, getAuth, onAuthStateChanged, signInWithPopup, signInWithEmailAndPassword } from "firebase/auth";
                    ...
                    <div className="max-w-md mx-auto">
                        ...
                        <div className="divide-y divide-gray-200">
                            <form onSubmit={handleLogIn} className="py-8 text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7">
                                ...
                                <p>
                                    If you haven't an account. Please <Link to="/sign-up" className='text-blue-600 underline'>Sign Up</Link>
                                </p>
                                <div className="relative">
